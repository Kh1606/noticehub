"""
제주시청 고시 공고 — jejusi.go.kr/information/intro/notice.do

Listing cols: 번호 / 공고번호 / 제목 / 담당부서 / 게재일 / 게재기간
Title col 2, date col 4. Detail link: /information/intro/notice.do?mode=detail&ancmnt_pbanc_mng_no=...
"""
...
SOURCE = SourceMeta(
    ...
    sub_entity="제주시청",
    source_page="고시 공고",
    source_url="https://www.jejusi.go.kr/information/intro/notice.do",
)
...
def scrape() -> list[Notice]:
    ...
    for tr in body.find_all("tr"):
        ...
        if not title or "mode=detail" not in detail_url:
            continue
